...
import {Button, Divider, Input, Rate, Slider, Tag} from "antd";
        ...
        <DogDogContainer>
            ...
            <div style={{margin: '0px auto', width: 1350}}>
                ...
                <div style={{width: 260, float: 'left', padding: 10}}>
                    ...
                    {varietyCheck.map(value => <Tag color="cyan">{value} <Button type={'danger'} size={'small'}
                                                                                 style={{borderRadius: 12}}
                                                                                 onClick={() => changeChecked(false, {name: value})}>x</Button></Tag>)}
                    ...
                    {productList.map(value => {
                        return <div
                            ...
                            <div style={{textAlign: 'left'}}>
                                <span style={{fontWeight: 700, marginRight: '5px'}}>{value.title}</span>{value.subTitle}
                            </div>
